...
2	SQL	Learning Relational Databases	20
\.
...
1	Ramona	Soderlind	rsoderlind
2	Deanna	Gao	deantgao
\.
...
--
-- Name: projects_title_key; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: students_github_key; Type: CONSTRAINT; Schema: public; Owner: user
--
